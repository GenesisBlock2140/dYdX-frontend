    ...
    <>
      <div className='mt-[120px]'>
        ...
        <div className='mt-[40px] mb-[80px] text-center text-white font-["Circular"]'>
          ...
          <button className='bg-[#6966FF] py-[12px] px-[39px] rounded-[8px] w-[80%] sm:max-w-[190px] sm:mr-[24px]'>Apply for grant</button>
        </div>
        <div className='sm:flex max-w-[1000px] mx-auto justify-center justify-around text-white text-[20px] font-["Space_Mono"] text-center'>
          <p>100+ <span className='block text-[#C8C7D8] text-[18px]  mb-[32px]'>projects funded</span></p>
          <p>$3+ milion<span className='block text-[#C8C7D8] text-[18px]  mb-[32px]'>awarded</span></p>
          <p>400+ <span className='block text-[#C8C7D8] text-[18px]'>projects funded</span></p>
        </div>
      </div>
    </>
  )
